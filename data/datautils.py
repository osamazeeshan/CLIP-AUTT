...
ID_to_DIRNAME={
    ...
    'raftrains': 'aligned_train',
    'raftests': 'aligned_test',
...
def build_dataset(set_id, transform, data_root, mode='test', n_shot=None, split="all", bongard_anno=False, sub_id='1', use_landmarks=False, max_landmarks=None):
    if set_id == 'I':
