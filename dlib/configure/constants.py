...
AFFECTNET = 'AffectNet'
AFFWILD2 = 'AFF-WILD2'
RAFDB_AFFECTNET_AFFWILD2 = "RAF-DB_AffectNet_AFF-WILD2"
RAFDB_COMPOUND = "RAF-DB-COMPOUND"
...
# Augmented validation set from valid of 'RAFDB_AFFECTNET_AFFWILD2' to be
# used for model selection over RAFDB_COMPOUND and
# C_EXPR_DB/C_EXPR_DB-CHALLENGE using different augmentations.

AUG_COMP_VALID_RAFDB_COMPOUND_MIXUP_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_mixup'
AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_cutmix_h'
AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_V_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_cutmix_v'
AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_V_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_cutmix_h_v'
AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_r_mixup_cutmix_h'
AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_V_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_r_mixup_cutmix_v'
AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_V_AUG = 'AUG_COMP_VALID_RAFDB_COMPOUND_r_mixup_cutmix_h_v'

AUG_COMP_VALID_C_EXPR_DB_MIXUP_AUG = 'AUG_COMP_VALID_C_EXPR_DB_mixup'
AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_AUG = 'AUG_COMP_VALID_C_EXPR_DB_cutmix_h'
AUG_COMP_VALID_C_EXPR_DB_CUTMIX_V_AUG = 'AUG_COMP_VALID_C_EXPR_DB_cutmix_v'
AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_V_AUG = 'AUG_COMP_VALID_C_EXPR_DB_cutmix_h_v'
AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_AUG = 'AUG_COMP_VALID_C_EXPR_DB_r_mixup_cutmix_h'
AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_V_AUG = 'AUG_COMP_VALID_C_EXPR_DB_r_mixup_cutmix_v'
AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_V_AUG = 'AUG_COMP_VALID_C_EXPR_DB_r_mixup_cutmix_h_v'
...
if DEBUG:
    ...
    RAFDB_AFFECTNET_AFFWILD2 = FORMAT_DEBUG.format(RAFDB_AFFECTNET_AFFWILD2)
    RAFDB_COMPOUND = FORMAT_DEBUG.format(RAFDB_COMPOUND)
    C_EXPR_DB = FORMAT_DEBUG.format(C_EXPR_DB)
    C_EXPR_DB_CHALLENGE = FORMAT_DEBUG.format(C_EXPR_DB_CHALLENGE)
...
DATASETS = [RAFDB, AFFECTNET, CUB, ILSVRC, OpenImages,
            RAFDB_AFFECTNET_AFFWILD2,
            RAFDB_COMPOUND,
            C_EXPR_DB,
            C_EXPR_DB_CHALLENGE,

            AUG_COMP_VALID_RAFDB_COMPOUND_MIXUP_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_V_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_V_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_V_AUG,
            AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_V_AUG,

            AUG_COMP_VALID_C_EXPR_DB_MIXUP_AUG,
            AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_AUG,
            AUG_COMP_VALID_C_EXPR_DB_CUTMIX_V_AUG,
            AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_V_AUG,
            AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_AUG,
            AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_V_AUG,
            AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_V_AUG
...
NBR_CHUNKS_TR = {
    ...
    'RAF-DB': -1,
    'AffectNet': -1,
    'RAFDB_AFFECTNET_AFFWILD2': -1,
    'RAFDB_COMPOUND': -1,
    'C-EXPR-DB': -1,
    'C-EXPR-DB-CHALLENGE': -1,
    'CUB': -1,
    'DEBUG_CUB': -1,
    'OpenImages': -1,
    'DEBUG_OpenImages': -1,
...
NUMBER_CLASSES = {
    ...
    RAFDB: 7,
    AFFECTNET: 7,
    RAFDB_AFFECTNET_AFFWILD2: 6,
    RAFDB_COMPOUND: 11,
    C_EXPR_DB: 7,
    C_EXPR_DB_CHALLENGE: 7,

    AUG_COMP_VALID_RAFDB_COMPOUND_MIXUP_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_V_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_CUTMIX_H_V_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_V_AUG: 11,
    AUG_COMP_VALID_RAFDB_COMPOUND_RAND_MIXUP_CUTMIX_H_V_AUG: 11,

    AUG_COMP_VALID_C_EXPR_DB_MIXUP_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_CUTMIX_V_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_CUTMIX_H_V_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_V_AUG: 7,
    AUG_COMP_VALID_C_EXPR_DB_RAND_MIXUP_CUTMIX_H_V_AUG: 7
}
...
HAPPILY_DISGUSTED = "Happily Disgusted"
SADLY_DISGUSTED = "Sadly Disgusted"
FEARFULLY_ANGRY = "Fearfully Angry"
ANGRILY_DISGUSTED = "Angrily Disgusted"
...
COMPOUND_TO_BASIC = {
    ...
    HAPPILY_SURPRISED: [HAPPINESS, SURPRISE],
    SADLY_SURPRISED: [SADNESS, SURPRISE],
    DISGUSTEDLY_SURPRISED: [DISGUST, SURPRISE],
    ANGRILY_SURPRISED: [ANGER, SURPRISE],
    SADLY_FEARFUL: [SADNESS, FEAR],
    SADLY_ANGRY: [SADNESS, ANGER],
    # RAFD-DB Compound
    HAPPILY_DISGUSTED: [HAPPINESS, DISGUST],
    SADLY_DISGUSTED: [SADNESS, DISGUST],
    FEARFULLY_ANGRY: [FEAR, ANGER],
    ANGRILY_DISGUSTED: [ANGER, DISGUST]
}
...
# data augmentation
MIXUP_AUG = 'mixup'  # mixup augmentation.
CUTMIX_H_AUG = 'cutmix_h'  # cutmix data augmentation: horizontal
CUTMIX_V_AUG = 'cutmix_v'  # cutmix data augmentation: vertical
CUTMIX_H_V_AUG = 'cutmix_h_v'  # cutmix data augmentation: random
# horizontal/vertical
RAND_MIXUP_CUTMIX_H_AUG = 'r_mixup_cutmix_h'  # choose randomly between
# mixup and cutmix horizontal.
RAND_MIXUP_CUTMIX_V_AUG = 'r_mixup_cutmix_v'  # choose randomly between
# mixup and cutmix vertical.
RAND_MIXUP_CUTMIX_H_V_AUG = 'r_mixup_cutmix_h_v'  # choose randomly
# between mixup and cutmix random horizontal/vertical.

DATA_AUGS = [MIXUP_AUG,
             CUTMIX_H_AUG,
             CUTMIX_V_AUG,
             CUTMIX_H_V_AUG,
             RAND_MIXUP_CUTMIX_H_AUG,
             RAND_MIXUP_CUTMIX_V_AUG,
             RAND_MIXUP_CUTMIX_H_V_AUG
             ]

# augmentation space: input image or embedding.
INPUT_SPACE = 'input'
EMBED_SPACE = 'embed'

DATA_SPACES = [INPUT_SPACE, EMBED_SPACE]

# loss
LOSS_CE = 'CE'  # cross-entropy for multi-class
LOSS_BCE = 'bce'  # binary cross-entropy loss for multi-label
LOSS_KL = 'kl'  # useful when using augmented data along with basic data.
# automatically applies CE over basic samples, and something close to BCE
# over composed samples.
LOSS_CE2 = 'CE2'  # uses 2 CE losses to deal with compound samples. this
# means that the classifier must use softmax. a single loss that can bealth
# with both, basic and compound emotions.
LOSS_AUG_FT = 'aug_ft'  # loss over augmented features from basic to compound.

LOSSES = [LOSS_CE, LOSS_BCE, LOSS_KL, LOSS_CE2, LOSS_AUG_FT]


# output types:
SIGMOID_OUT = 'sigmoid'  # output requires sigmoid to get probs.
SOFTMAX_OUT = 'softmax'  # output requires softmax to get probs.
OUT_TYPES = [SIGMOID_OUT, SOFTMAX_OUT]

# basic probs aggregations
BASIC_AGG_MAX = 'max'  # max 2 basic probs
BASIC_AGG_AVG = 'avg'  # average two basic probs.
BASIC_AGGS = [BASIC_AGG_AVG, BASIC_AGG_MAX]
...
HEADS = [BASIC_HEAD, COMPOUND_HEAD, BOTH_HEADS]

# Agreement loss
KL_AGR = 'KL'
MSE_AGR = 'MSE'
AGR_LOSSES = [KL_AGR, MSE_AGR]

# loss KD
KD_MSE = 'mse'
KD_IND_KL = 'ind_kl'  # considers basic classes independent.
KD_DEP_KL = 'dep_kl'  # considers basic classes dependent.

KD_LOSSES = [KD_MSE, KD_IND_KL, KD_DEP_KL]
