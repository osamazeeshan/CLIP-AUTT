...
from dlib.fer_models.apvit_classifiers_base import BaseClassifier
from dlib.fer_models.irse import IR_50
from dlib.fer_models.apvit_vit_vit_siam_merge import PoolingViT
from dlib.fer_models.apvit_heads_linear_head import LinearClsHead
from dlib.fer_models.apvit_heads_linear_head import MultiLinearClsHead
...
VIT_CONFIG = dict(
    ...
    input_type='feature',
    patch_num=196,  # NOTE: setting 169 for Biovid ; Original value=196
    in_channels=[256],
